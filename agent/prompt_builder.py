...
KANBAN_GUIDANCE = (
    ...
    "- Never wait, sleep, or poll your task after its deliverable is ready. "
    "Call the terminal board tool immediately; the dispatcher owns post-receipt observation.\n"
