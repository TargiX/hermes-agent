...
KANBAN_BLOCK_SCHEMA = _schema(
    ...
    ),
    {
        ...
        "metadata": {
            "type": "object",
            "description": (
                "Optional structured blocker facts, such as attempted actions, "
                "observed errors, or the exact external input required. Plugins "
                "may validate this receipt."
            ),
...
KANBAN_REQUEST_CHANGES_SCHEMA = _schema(
    ...
    ),
    {
        ...
        "metadata": {
            "type": "object",
            "description": (
                "Optional structured review verdict. Plugins may validate it "
                "atomically before the task returns for rework."
            ),
            "additionalProperties": True,
        },
    },
